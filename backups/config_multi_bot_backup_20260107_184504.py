...
# Fallback Responses
FALLBACK_RESPONSES = {
    'no_keywords': """Dazu habe ich leider keine Informationen.""",
    'llm_error': """Entschuldigung, technisches Problem.""",
    'ambiguous': """Bitte formuliere deine Frage konkreter.""",
    'out_of_scope': """Diese Frage gehört nicht zu meinen Themen.""",
    'validation_failed': """Ich konnte keine sichere Antwort formulieren.""",
